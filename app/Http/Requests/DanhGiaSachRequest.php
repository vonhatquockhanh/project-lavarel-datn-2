...
class DanhGiaSachRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'sach_id' => 'required|exists:sachs,id', 
    ...
    public function messages(){
        return[
            ...
            'sach_id.required' => 'Sách không được để trống.',
            'sach_id.exists' => 'Sách không tồn tại trong hệ thống.',
