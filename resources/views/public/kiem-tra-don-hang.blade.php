...
<div class="container-fluid justify-content-center">
    <div class="card my-4 w-100 border-0">
        <div class="my-4 p-3 custom-bg card-header-border">
            <h4 class="m-0">Kiểm tra đơn hàng</h4>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="cart-product">
                    <h4>
                        <a href="{{route('gioHang')}}" title="Back to cart" class="">
        ...
        <div class="row equal-height">
           <div class="col-lg-8">
                <div class="cart-summary my-3 h-100">
                    <div class="card h-100 border-0">
                        <div class=" p-3 card-header custom-bg card-header-border">
                            <h4 class="m-0">Thông tin nhận hàng và thanh toán</h4>
                        </div>
                ...
                <div class="cart-summary my-3 h-100">
                    <div class="card h-40">
                        ...
                        <div class="card-body">
                            ...
                            <p>Phí vận chuyển = <span id="phi_van_chuyen" class="highlighted-text">0.00 VNĐ</span></p>
                            <p><strong>Thành tiền = <span id="tong_chi_phi" class="highlighted-text">{{number_format(Cart::total(), 0, ',', '.')}} VNĐ</span></strong></p>
                        </div>
                    </div>
                </div>
            </div>
...
/* Thêm viền cho "Kiểm tra đơn hàng" */
.card-header-border {
...
.table img {
    border-radius: 5px;
    width: 100px; /* Điều chỉnh chiều rộng ảnh nếu cần */
    height: auto; /* Giữ tỷ lệ ảnh */
}

.total-amount-display, .total-amount-display span, #phi_van_chuyen, #tong_chi_phi {
    font-weight: bold;
    font-size: 1.2em;
    color: red;
