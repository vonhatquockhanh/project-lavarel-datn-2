        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card card-body my-3">
                    ...
                    <p><a href="{{route('user.danh-gia-cua-toi')}}" class="mr-2"><i class="fas fa-comments mr-1"></i> Đánh giá</a> {{Auth::user()->danhGiaSach ? Auth::user()->danhGiaSach->count(): 'Bạn chưa để lại đánh gía nào'}}</p>
                </div>
            </div>
        </div>
    </div>
