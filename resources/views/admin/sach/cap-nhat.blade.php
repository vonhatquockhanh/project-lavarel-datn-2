            ...
            <form method="POST" action="{{ route('admin.sach.xu-ly-cap-nhat', ['id' => $sach->id]) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="tac_gia_id" name="tac_gia_id" required>
                            ...
                            <option value="{{ $tacGia->id }}" @if($sach->tac_gia_id == $tacGia->id) selected @endif>{{ $tacGia->ten_tac_gia }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="gia_goc" name="gia_goc" value="{{ $sach->gia_goc }}" required>
                    </div>
                    <div class="col-md-3">
